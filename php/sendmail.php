            ...
            if($_GET['form'] === "contact") {
                ...
                if(
                    ...
                    try {
                        ...
                        $mail->Host       = 'c2460306.ferozo.com';                     //Set the SMTP server to send through
                        $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
                        $mail->Username   = 'no-reply@c2460306.ferozo.com';                     //SMTP username
                        $mail->Password   = 'mIKW@PcO3C';                               //SMTP password
